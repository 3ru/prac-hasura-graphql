...
export const handlers = [
    ...
    return res(
      ctx.data({
        users: [
          {
            __typename: 'users',
            id: 'b7137849-7f1d-c2db-e609-22056fb86db3',
            name: 'Test user A',
            created_at: '2021-01-13T18:06:46.412969+00:00',
          },
          {
            __typename: 'users',
            id: '3b07950f-9959-1bc7-834d-5656e4aeaac2',
            name: 'Test user B',
  ...
  graphql.query('GetUserById', (req, res, ctx) => {
    ...
    if (id === 'b7137849-7f1d-c2db-e609-22056fb86db3') {
      return res(
        ctx.data({
          users_by_pk: {
            __typename: 'users',
    ...
    if (id === '3b07950f-9959-1bc7-834d-5656e4aeaac2') {
      return res(
        ctx.data({
          users_by_pk: {
            __typename: 'users',
