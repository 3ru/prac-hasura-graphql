...
describe('Hasura CRUD Test Cases', () => {
  it('Should render the list of users by useQuery', async () => {
    ...
    expect(
      screen.getByTestId('edit-b7137849-7f1d-c2db-e609-22056fb86db3')
    ).toBeTruthy()
    expect(
      screen.getByTestId('delete-b7137849-7f1d-c2db-e609-22056fb86db3')
    ).toBeTruthy()
    ...
    expect(
      screen.getByTestId('edit-3b07950f-9959-1bc7-834d-5656e4aeaac2')
    ).toBeTruthy()
    expect(
      screen.getByTestId('delete-3b07950f-9959-1bc7-834d-5656e4aeaac2')
    ).toBeTruthy()
